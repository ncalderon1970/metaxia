...
<?php /* casos section should be here - re-adding from original */ ?>
<?php endif; // casos tab ?>
...
try {
    ...
    $stmtPPct->execute([$cid, (int)($condicion['id'] ?? 0)]);
    $rPct = $stmtPPct->fetch();
...
<?php if ($condicion && str_starts_with((string)($condicion['tipo_condicion'] ?? ''), 'tea')): ?>
<div style="margin-bottom:1rem;">
    <a href="<?= APP_URL ?>/modules/inclusion/protocolo_tea.php?alumno_id=<?= $id ?>&condicion_id=<?= (int)$condicion['id'] ?>&origen=alumno"
