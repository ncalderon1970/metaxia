...
if (!function_exists('metis_seg_topbar_action_visible')) {
    function metis_seg_topbar_action_visible(PDO $pdo, string $key, bool $default = false): bool
    {
        try {
...
$mostrarAlertaTopbarExpediente = metis_seg_topbar_action_visible($pdo, 'alertas', false);
